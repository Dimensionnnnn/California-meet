...
<body>
    <div class="form__container">
        <div class="form__wrapper">
            <form action="./vendor/profile-config-registr.php" class="form__configuration" method="post" enctype="multipart/form-data">
                <label class="form__label">Имя</label>
                <input required class="form__input" type="text" name="user-name">
                <label class="form__label">Возраст</label>
                <input required class="form__input" type="number" name="user-age" placeholder="Вы должны быть старше 18 лет!">
